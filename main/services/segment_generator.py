...
class SegmentGenerator(AudioSegment):
    ...
    def segment(self, start_time_seconds, duration_seconds, prefix=""):
        """
        ...
        """
        os.mkdir("{}{}".format(prefix, self.segments_path))
        download = AudioSegment.from_file(
            file="{}{}".format(prefix, self.download_path),
        ...
        for segment_index in range(1, segment_count+1):
            ...
            segment_i_path = prefix + self.segments_path + "/" + "segment" + str(segment_index) + ".mp3"
